            ...
            try {
                switch (req) {
                    ...
                    case "deadline": {
                        ...
                        String[] descArray = desc.split(" /by ", 2);
                    ...
                    case "event": {
                        ...
                        String desc = inputArray[1];
                        String[] descArray = desc.split(" /from ", 2);
                        //NEED TO ADD IF LIKE TIME GIVEN IS 600 not 0600 for 6am, need ask them give in HHMM format
                        /*
                        if (descArray.length <= 2) {
                            throw new TheoException("Huh? Both start and end times has to be specified.");
                        }*/
                        String name = descArray[0];
                        String timings = descArray[1];
                        String[] timingArray = timings.split(" /to ", 2);
                        String start = timingArray[0];
                        String end = timingArray[1];
